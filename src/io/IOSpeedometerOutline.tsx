...
export default function IOSpeedometerOutline(props:{size?:number; width?:number;height?:number}) {
...
if(width===undefined && height===undefined){width=16;height=16;}
  ...
  return (
    <svg className="glx--icon glx-io-icon" width={ width } height={ height }
      ...
      viewBox="0 0 512 512"
    >
      <path d="M326.1 231.9l-47.5 75.5a31 31 0 01-7 7 30.11 30.11 0 01-35-49l75.5-47.5a10.23 10.23 0 0111.7 0 10.06 10.06 0 012.3 14z"></path>
      <path
        fill="none"
        stroke="#000"
        strokeLinecap="round"
