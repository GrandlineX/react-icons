...
export default function IOLeafSharp(props:{size?:number; width?:number;height?:number}) {
...
if(width===undefined && height===undefined){width=16;height=16;}
  ...
  return (
    ...
    >
      ...
      <path d="M467.43 384.19c-16.83-2.59-33.13-5.84-49-9.77a158.49 158.49 0 01-12.13 25.68c-.74 1.25-1.51 2.49-2.29 3.71a583.43 583.43 0 0058.55 12l15.82 2.44 4.86-31.63z"></path>
    </svg>
  );
}
