...
export default function IORestaurantOutline(props:{size?:number; width?:number;height?:number}) {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="32"
        d="M200 368l-99.72 100.28a40 40 0 01-56.56 0h0a40 40 0 010-56.56L128 328"
      ></path>
    </svg>
  );
}
